                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-8">
                                            ...
                                            <select id="category_id" class="form-control select2bs4" style="width: 100%;">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{$category->id}}"
                                                            @if($note->category_id == $category->id) selected @endif>{{$category->title}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input id="title" value="{{$note->title}}" type="text"
                                                   class="form-control"
                                                   placeholder="Category En. name">
                                        </div>
                                        <div class="form-group">
                                            <label for="details">Note Details</label>
                                            <input id="details" value="{{$note->details}}" type="text"
                                                   class="form-control"
                                                   placeholder="Category Ar. name">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
