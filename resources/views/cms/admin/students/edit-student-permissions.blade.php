                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Notes System - Update Student Permissions</h3>
                            <a href="#" onclick="updateStudentPermissions('{{$student->id}}')" class="btn btn-sm btn-info float-right">Update
                                Permissions</a>
                        </div>
                        <!-- /.card-header -->
                                            ...
                                            @else
                                                <div class="form-check">
                                                    <input type="checkbox" name="{{$permission->name}}"
                                                           ...
                                                           @if($studentPermission->id == $permission->id)
                                                           checked
                                                        @endif
                                                        @endforeach
                                                    >
...
@section('scripts')
    ...
    <script>
        ...
        selectedPermissions.push('{{$studentPermission->id}}');
        ...
        function updateStudentPermissions(id) {
            axios.post('/cms/admin/students/' + id + '/update-permissions', {
