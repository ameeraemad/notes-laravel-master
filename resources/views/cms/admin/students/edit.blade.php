                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" id="update_student_form">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label>API UUID</label>
                                            <input value="{{$student->api_uuid}}" type="text"
                                                   class="form-control" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Full Name</label>
                                            <input id="name" value="{{$student->name}}" type="text"
                                                   class="form-control"
                                                   placeholder="Enter name">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Email</label>
                                            <input id="email" value="{{$student->email}}" type="email"
                                                   class="form-control" placeholder="Enter email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Mobile</label>
                                            <input id="mobile" value="{{$student->mobile}}" type="tel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input" type="radio" id="Male"
                                                       ...
                                                       @if($student->gender == 'Male') checked @else checked @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                           name="account_status"
                                                           id="account_status"
                                                           @if($student->status == 'Active') checked @endif>
                                ...
                                <div class="card-footer">
                                    <button type="button" onclick="updateAdmin('{{$student->id}}')"
...
@section('scripts')
    ...
    <script>
        function updateAdmin(id) {
            ...
            @if(auth('admin')->check())
                params["status"] = document.getElementById("account_status").checked == true ? "Active" : "Blocked";
            @endif

            axios.put('/cms/admin/students/' + id, params)
